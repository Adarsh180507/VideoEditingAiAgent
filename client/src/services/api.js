...
// In production, this would be your deployed backend URL via environment variables
...
export const uploadDirectlyToCloudinary = async (file, onProgress) => {
    try {
        ...
        // Step C: Upload directly to Cloudinary's servers
 ...
 */
export const startVideoProcessingJob = async (videoUrl, publicId, originalName, prompt) => {
    try {
...
export const checkJobStatus = async (jobId) => {
    try {
        ...
        return response.data; // Returns { id, state, progress, result, failedReason }
    } catch (error) {
